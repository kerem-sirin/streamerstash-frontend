        ...
        <div className="max-w-md mx-auto mt-10">
            ...
            <form onSubmit={onSubmit} className="bg-white dark:bg-dark-secondary shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div className="flex items-center justify-center">
                    <button className="bg-primary hover:bg-primary-focus text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">Create Account</button>
                </div>
            </form>
