...
const RegisterPage = () => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            // NOTE: We'll save the token here later
    ...
    return (
        <div className="max-w-md mx-auto mt-10">
            ...
            <p className="text-center text-gray-500 dark:text-gray-400 text-sm">
                ...
                <Link to="/login" className="font-bold text-purple-600 hover:text-purple-800 dark:text-purple-400 dark:hover:text-purple-300">
                    Login here
                </Link>
            </p>
        </div>
